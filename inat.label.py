...
def create_inaturalist_label(observation_data, iconic_taxon_name):
    ...
    for field_name in dna_fields:
        ...
        if dna_value:
            ...
            # Clean the sequence and get its length
...
"""
    ...
    try:
        for label, iconic_taxon_name in labels:
            ...
            qr_url = next((value for field, value in label if field in ["iNaturalist URL", "Mushroom Observer URL"]), None)
...
if __name__ == "__main__":
    ...
    for input_value in observation_ids:
        ...
        # Otherwise create the label
            ...
            label, updated_iconic_taxon = create_inaturalist_label(observation_data, iconic_taxon_name)
